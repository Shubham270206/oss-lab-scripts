...
echo "but because someone chose to share it freely."           >> "$OUTPUT"
echo ""                                                         >> "$OUTPUT"
echo "To me, freedom means $FREEDOM."                          >> "$OUTPUT"
echo "In the world of software, that freedom is not just"      >> "$OUTPUT"
echo "a feature — it is the foundation. The freedom to read"   >> "$OUTPUT"
echo "the code, to change it, to learn from it, and to"        >> "$OUTPUT"
echo "pass it on."                                              >> "$OUTPUT"
echo ""                                                         >> "$OUTPUT"
...
echo "Today it runs the internet, the cloud, and every"        >> "$OUTPUT"
echo "Android phone. That is what happens when knowledge"      >> "$OUTPUT"
echo "is set free."                                             >> "$OUTPUT"
echo ""                                                         >> "$OUTPUT"
