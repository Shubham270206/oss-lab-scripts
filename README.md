...
**Student Name:** Shubham Sinha
**Roll Number:** 24BAI10656
...
```bash
git clone https://github.com/Shubham270206/oss-lab-scripts.git
cd oss-lab-scripts
```
...
the VIT Bhopal OSS Capstone Project by Shubham Sinha (24BAI10656).